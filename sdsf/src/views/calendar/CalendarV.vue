<template>
  <div class="timetable w100 h-adjust">
    <div class="time-b w100">
      ...
      <div class="time-controller">
        <el-button-group>
          ...
          ></el-button>
          <el-button class="date-btn" round>本周</el-button>
          <el-button
    ...
    <div class="timetable-b w100 h-adjust">
          ...
          <template v-for="(item3, index3) in weeks" :key="index3">
            ...
            >
              <div
                  ...
                  class="dmsjandjs-b"
              >
                <p>{{ showData(index3, index2).building }}</p>
                <p>{{ showData(index3, index2).room }}</p>
                <p>{{ showData(index3, index2).course }}</p>
              </div>
            </td>
          </template>
        </tr>
...
import {colorList, weekCourse} from "./timeTable";
